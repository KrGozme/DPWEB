...
class ProductoModel {
    ...
    public function actualizar($id_producto, $codigo, $nombre, $detalle, $precio, $stock, $id_categoria, $fecha_vencimiento, $imagen, $id_proveedor) {   // Escapar datos para evitar errores o inyecciones simples
        $codigo = $this->conexion->real_escape_string($codigo);
